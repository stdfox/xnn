...
fn assert_vec_relative_eq(actual: &[f32], expected: &[f32], epsilon: f32) {
...
fn test_matmul_2d_square() {
    ...
    assert_vec_relative_eq(&c.to_vec().unwrap(), &[19.0, 22.0, 43.0, 50.0], 1e-4);
}
...
fn test_matmul_3d() {
    ...
    for b_idx in 0..batch {
        ...
        assert_vec_relative_eq(result, &cpu_matmul(a_slice, b_slice, m, k, n), 1e-4);
    }
}
