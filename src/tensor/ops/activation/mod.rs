...
/// Generates WGSL shader for activation operations with vec4 optimization.
fn activation_shader(ty: &str, expr: &str) -> String {
...
/// Dispatches an activation operation compute shader.
fn dispatch(
    ctx: &Context,
    a: &wgpu::Buffer,
    b: &wgpu::Buffer,
