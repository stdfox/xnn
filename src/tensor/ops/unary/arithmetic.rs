...
impl_arithmetic_op!(log2, "log2(a[tid])", Log2, FloatElement);
impl_arithmetic_op!(rcp, "1.0 / a[tid]", Rcp, FloatElement);
impl_arithmetic_op!(rsqr, "1.0 / (a[tid] * a[tid])", Rsqr, FloatElement);
impl_arithmetic_op!(rsqrt, "inverseSqrt(a[tid])", Rsqrt, FloatElement);
impl_arithmetic_op!(sin, "sin(a[tid])", Sin, FloatElement);
impl_arithmetic_op!(sinh, "sinh(a[tid])", Sinh, FloatElement);
impl_arithmetic_op!(sqr, "a[tid] * a[tid]", Sqr, FloatElement);
impl_arithmetic_op!(sqrt, "sqrt(a[tid])", Sqrt, FloatElement);
